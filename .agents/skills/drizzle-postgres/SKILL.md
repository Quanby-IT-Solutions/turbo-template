...
import { schema, todos, users } from "@repo/db/schema" // Tables and schema
```
...
export const schema = Object.assign({ users, sessions, accounts, verifications, todos }, relations)
```
