...
export const v1Example = oc.prefix("/example").router(oc.router({ todo: todoContract }))
```
...
export const v1Contract = oc
	.prefix("/v1")
	.router(oc.router({ health: healthContract, example: v1Example }))
