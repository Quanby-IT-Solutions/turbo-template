...
} from "@/features/admin/hooks/use-doctor-schedules"
						...
						<div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
							<div className="px-4 lg:px-6">
								...
								<div className="mb-6 flex items-center justify-between">
									<div>
										<h1 className="mb-2 text-2xl font-bold">Schedule Management</h1>
												...
												<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
													...
													>
														<SelectTrigger>
															{selectedDoctor ? (
																<span>
																	{doctors.find((d: any) => d.id === selectedDoctor)?.name ||
																		"All Doctors"}
																</span>
															) : (
													...
													<div className="relative">
														<Input
															...
															className="pr-10"
														/>
														<IconCalendar className="text-muted-foreground pointer-events-none absolute top-1/2 right-3 h-4 w-4 -translate-y-1/2" />
													</div>
												</div>
												...
												<div className="flex items-center justify-between">
													<div>
														...
														<p className="text-muted-foreground mt-1 text-sm">
															Showing {filteredSchedules.length} schedules ({availableCount}{" "}
															available)
														</p>
													</div>
												</div>
												...
												{isLoadingSchedules ? (
													...
													<div className="flex flex-col items-center justify-center py-16">
														<div className="bg-muted mb-4 flex h-16 w-16 items-center justify-center rounded-full">
															<IconClock className="text-muted-foreground h-8 w-8" />
														</div>
							...
							<div className="grid gap-2">
								...
								>
									<SelectTrigger id="doctor">
										{formDoctorId ? (
											<span>
												{doctors.find((d: any) => d.id === formDoctorId)?.name || formDoctorId}
											</span>
										) : (
