      ...
      >
        ...
        <SidebarInset>
          <RoleHeader 
            ...
            description="View complete details of the laboratory test request"
          />
                ...
                <Card className="shadow-sm">
                  ...
                  <CardContent className="space-y-6 pt-0">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-7">
                        <div className="space-y-1">
                          <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Patient Name</p>
                          <p className="text-base font-medium">{labRequest.patientName || "Unknown Patient"}</p>
                        </div>
                      </div>
                    </div>
